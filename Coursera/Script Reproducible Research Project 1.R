...
##Time Series Plot of Average Number of Steps Each day
Q4<-Q3
...
##Code to Show Strategy for Imputing Missing Data
##Mean/Mode Value Substitutions
Q6<-activity
...
##Histogram of the Number of Steps Taken After Imputation
png("plot7.png")
qplot(Q6.6$Steps,geom="histogram",main="Total steps taken histogram post imputation",xlab="Steps",ylab="Count")
dev.off()
qplot(Q6.6$Steps,geom="histogram",main="Total steps taken histogram post imputation",xlab="Steps",ylab="Count")

##Panel Plot Comparing Average Number of Steps Per 5 Minute Interval Across Weedays and Weekends
Q8<-Q6.6
